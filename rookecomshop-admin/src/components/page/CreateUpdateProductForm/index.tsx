...
const CreateUpdateProductForm : FC<CreateUpdateProductFormProps> = ({defaultValue, handleSubmitForm}) => {
    const dispatch = useAppDispatch();
	const { categories, isLoading: categoryLoading, selectedTopCategory } = useAppSelector((state) => state.categories);
												...
												<FormField
													...
													render={({ field }) => (
														<FormItem>
															...
															<Select defaultValue={defaultValue?.categoryName} onValueChange={(value) => {
                                                                const getCategory = categories.find((category) => category.name === value);
                                                                dispatch(setSelectedTopCategory(getCategory));
